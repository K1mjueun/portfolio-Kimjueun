...
//   };
  ...
  const windieMenu = {
    ...
    menuHome : windieMenu.menuBox.children[0],
    menuCinema : windieMenu.menuBox.children[1],
    menuMagazine : windieMenu.menuBox.children[2]
  }

  const windiePages = {
    homeP : document.querySelector("#home"),
    cinemaP : document.querySelector("#cinema"),
    magazineP : document.querySelector("#magazine")
  }

  displayChange(windieMenu.menuHome,firstP,windiePages.homeP);
  displayChange(windieMenu.menuCinema,firstP,windiePages.cinemaP);
  displayChange(windieMenu.menuMagazine,firstP,windiePages.magazineP);
